...
const globalTypography = (selectedTypo) => {
    ...
    let CSS = '{';
    CSS += `font-family:var(--wprig-typo${selectedTypo}-font-family);`;
    CSS += `font-size:var(--wprig-typo${selectedTypo}-font-size);`;
    CSS += `font-weight:var(--wprig-typo${selectedTypo}-font-weight) !important;`;
    CSS += `font-style:var(--wprig-typo${selectedTypo}-font-style) !important;`;
    CSS += `line-height:var(--wprig-typo${selectedTypo}-line-height) !important;`;
    CSS += `letter-spacing:var(--wprig-typo${selectedTypo}-letter-spacing);`;
    CSS += `text-transform:var(--wprig-typo${selectedTypo}-text-transform);`;
    CSS += '}';
    return CSS;
