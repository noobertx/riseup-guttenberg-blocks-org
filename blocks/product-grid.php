...
/**
 * Registers the `wprig/productgrid` block on server.
 *
 * @since 1.1.0
 */
class WPRIG_Product_Grid {
	function __construct(){
		add_action('init', [$this,'register_block_wprig_productgrid'], 100);
	}
	function register_block_wprig_productgrid(){
		...
		register_block_type(
			...
			array(
				'attributes' => array(
					...
					'badgePadding' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-post-grid-wrapper .wprig-productgrid-cat-position'
							]
						]
					),
					'showDates' => array(
					...
					'pageAlignment' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination {text-align: {{pageAlignment}};}'
						]]
					),
					'paginationTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination > *'
						]]
					),
					'pagesColor' => array(
						'type' => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination > *{color: {{pagesColor}};}'
						]]
					),
					'pagesHoverColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination > a:hover, ' .
								'{{WPRIG}} .wprig-productgrid-pagination > button:hover{color: {{pagesHoverColor}};}'
						]]
					),
					'pagesActiveColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination > *.current{color: {{pagesActiveColor}};}'
						]]
					),
					...
					'pagesbgHoverColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination a:hover, ' .
								'{{WPRIG}} .wprig-productgrid-pagination button:hover'
						]]
					),
					'pagesbgActiveColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-pagination > .current'
						]]
					),
					...
					'separatorColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-1:not(:last-child) {border-bottom-color: {{separatorColor}};}'
						]]
					),
					...
					'separatorHeight' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-1:not(:last-child){border-bottom-style: solid;border-bottom-width: {{separatorHeight}};}'
							],
						],
					),
					...
					'separatorSpace' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-1:not(:last-child){padding-bottom: {{separatorSpace}};margin-bottom: {{separatorSpace}};}'
							],
						],
					),
					...
					'cardBackground' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-productgrid-style-2'
							]
						]
					),
					'cardBorder' => array(
					...
					'cardSpace' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 2]],
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-2:not(:last-child) {margin-bottom: {{cardSpace}};}'
							]
						]
					),
					'cardPadding' => array(
					...
					'stackBg' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-3 .wprig-post-list-wrapper .wprig-post-list-content'
							],
							(object) [
								'condition' => [
									(object) ['key' => 'layout', 'relation' => '==', 'value' => 2],
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-productgrid-style-3 .wprig-post-grid-content'
							]
						]
					),
					...
					'stackWidth' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-productgrid-style-3 .wprig-post-grid-img + .wprig-post-grid-content {width: {{stackWidth}};}'
							]
						]
					),
					'stackSpace' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-3:not(:last-child) {margin-bottom: {{stackSpace}};}'
							]
						]
					...
					'stackPadding' => array(
						...
						'style' => [
							...
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-productgrid-style-3 .wprig-post-grid-wrapper .wprig-post-grid-content'
							]
						]
					),
					...
					'titleTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-title'
						]]
					),
					'metaTypography' => array(
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-meta']]
					),
					'excerptTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-intro, {{WPRIG}} .wprig-productgrid-intro p'
						]]
					),
					'categoryTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-category a'
						]]
					),
					...
					'readmoreCustomSize' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-productgrid-btn-wrapper .wprig-productgrid-btn.wprig-button-fill.is-custom'
						]]
					),
					...
					'readmoreTypography' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showTitle', 'relation' => '==', 'value' => true]],
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-productgrid-btn'
						]]
					),
					'readmoreColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid a.wprig-productgrid-btn {color: {{readmoreColor}};}'
						]]
					...
					'readmoreColor2' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid a.wprig-productgrid-btn {color: {{readmoreColor2}};}'
						]]
					...
					'readmoreHoverColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid a.wprig-productgrid-btn:hover {color: {{readmoreHoverColor}};}'
						]]
					...
					'readmoreHoverBg' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'readmoreStyle', 'relation' => '==', 'value' => 'fill']],
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-productgrid-btn:hover'
						]]
					),
					...
					'contentPadding' => array(
						'type' => 'object',
						'default' => (object) array(),
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-post-grid-content,{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-post-list-content']]
					),
					'categoryRadius' => array(
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-category a']]
					),
					'titleColor' => array(
						'type'    => 'string',
						'default' => '#1b1b1b',
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-title a {color: {{titleColor}};}'
						]]
					),
					'titleOverlayColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-title a {color: {{titleOverlayColor}};}'
						]]
					),
					'titleHoverColor' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showTitle', 'relation' => '==', 'value' => true]],
							'selector' => '{{WPRIG}} .wprig-productgrid-title a:hover {color: {{titleHoverColor}};}'
						]]
					),
					'categoryColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-category a {color: {{categoryColor}};}'
						]]
					),
					'categoryColor2' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category a {color: {{categoryColor2}};}'
						]]
					),
					'categoryHoverColor' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'default']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category a:hover {color: {{categoryHoverColor}};}'
						]]
					),
					'categoryBackground' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category a {background: {{categoryBackground}};}'
						]]
					),
					'categoryHoverBackground' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category a:hover {background: {{categoryHoverBackground}};}'
						]]
					),
					...
					'categoryHoverColor2' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category a:hover {color: {{categoryHoverColor2}};}'
						]]
					),
					'metaColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-meta a {color: {{metaColor}};} {{WPRIG}} .wprig-productgrid-meta {color: {{metaColor}};} {{WPRIG}} .wprig-productgrid-meta span:before {background: {{metaColor}};}'
						]]
					),
					'metaOverlayColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-meta a {color: {{metaOverlayColor}};} {{WPRIG}} .wprig-productgrid-meta {color: {{metaOverlayColor}};} {{WPRIG}} .wprig-productgrid-meta span:before {background: {{metaOverlayColor}};}'
						]]
					),
					'excerptColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-intro {color: {{excerptColor}};}'
						]]
					),
					'excerptColor2' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-intro {color: {{excerptColor2}};}'
						]]
					),
					...
					'color' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid .wprig-post-list-content {color: {{color}};}'
						]]
					),
					'bgColor' => array(
						'type' => 'object',
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 1]],
							'selector' => '{{WPRIG}} .wprig-productgrid-wrapper'
						]]
					),
					'border' => array(
						'type' => 'object',
					...
					'overlayBg' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-style-4:before'
						]]
					),
					'overlayHoverBg' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
							'selector' => '{{WPRIG}} .wprig-productgrid-style-4:hover:before'
						]]
					),
					'overlayBorderRadius' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
								'selector' => '{{WPRIG}} .wprig-productgrid-style-4'
							]
						]
					),
					'overlaySpace' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-productgrid-style-4:not(:last-child) {margin-bottom: {{overlaySpace}};}'
							]
						]
					),
					'overlayHeight' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-productgrid-style-4 {height: {{overlayHeight}};}'
							]
						]
					),
					'overlayBlend' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
							'selector' => '{{WPRIG}} .wprig-productgrid.wprig-post-list-view.wprig-productgrid-style-4:before {mix-blend-mode: {{overlayBlend}};}'
						]]
					),
					//Spacing
					'columnGap' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-productgrid-column {grid-column-gap: {{columnGap}};}, {{WPRIG}} .wprig-productgrid-column {grid-row-gap: {{columnGap}};}'
						]]
					),
					'titleSpace' => array(
						'type' => 'object',
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-title {padding-bottom: {{titleSpace}};}']]
					),
					'categorySpace' => array(
						'type' => 'object',
						'default' => (object) array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'default']],
							'selector' => '{{WPRIG}} .wprig-productgrid-category {display:inline-block;padding-bottom: {{categorySpace}};}'
						]]
					),
					'metaSpace' => array(
						'type' => 'object',
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-meta {padding-bottom: {{metaSpace}};}']]
					),
					'excerptSpace' => array(
						'type' => 'object',
						'default' => (object) array(
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-intro {padding-bottom: {{excerptSpace}};}']]
					),
					'postSpace' => array(
						'type' => 'object',
						'default' => (object) array(
						...
						// 'style' => [(object) ['selector' => '{{WPRIG}} .wprig-productgrid-wrapper .wprig-productgrid']]
					),
					'interaction' => array(
						'type' => 'object',
						'default' => (object) array(),
				...
				'render_callback' => [$this,'render_block_wprig_productgrid']
			)
		);
	}
	function wprig_product_pagination_bar($max_pages, $current_page){
		if ($max_pages > 1) {
			$big = 9999999;
	...
	function render_block_wprig_productgrid($att){
		...
		//column
		if ($layout == 2) {
			$col = (' wprig-productgrid-column wprig-productgrid-column-md' . $column['md'] . ' wprig-productgrid-column-sm' . $column['sm'] . ' wprig-productgrid-column-xs' . $column['xs']);
		} else {
			$col = "";
		}
		$class = 'wp-block-wprig-productgrid wprig-block-' . $uniqueId;
		if (isset($att['align'])) {
		...
		if ($query->have_posts()) {
			...
			$html .= '<div class="wprig-productgrid-wrapper ' . $interaction . ' wprig-productgrid-layout-' . esc_attr($layout) . esc_attr($col) . '" ' . $animation . '>';
			while ($query->have_posts()) {
				$query->the_post();
				$id = get_post_thumbnail_id();
				$src = wp_get_attachment_image_src($id, $imgSize);
				$image = '<img class="wprig-post-image" src="' . esc_url($src[0]) . '" alt="' . get_the_title() . '"/>';
				$title = '<h3 class="wprig-productgrid-title"><a href="' . esc_url(get_the_permalink()) . '">' . get_the_title() . '</a></h3>';
				$category = '<span class="wprig-productgrid-category">' . get_the_category_list(' ') . '</span>';
				...
				$btn = '<div class="wprig-productgrid-btn-wrapper"><a class="wprig-productgrid-btn wprig-button-' . esc_attr($readmoreStyle) . ' is-' . esc_attr($readmoreSize) . '" href="' . esc_url(get_the_permalink()) . '">' . esc_attr($buttonText) . '</a></div>';
				$excerpt = '<div class="wprig-productgrid-intro">' . wprig_excerpt_max_charlength(esc_attr($limit)) . '</div>';
	
				if ($layout === 1) {
					$html .= '<div class="wprig-productgrid wprig-post-list-view wprig-productgrid-style-' . esc_attr($style) . '">';
					...
					if (($showImages == 1) && has_post_thumbnail()) {
						if ($showCategory == 'badge'  && $style == 4) {
							$html .= '<div class="wprig-productgrid-cat-position wprig-productgrid-cat-position-' . esc_attr($categoryPosition) . '">';
							$html .= $category;
							$html .= '</div>';
						}
					...
					if (($showAuthor == 1) || ($showDates == 1) || ($showComment == 1)) {
						$html .= '<div class="wprig-productgrid-meta">';
						$html .= $meta;
						$html .= '</div>';
					}
					...
					$html .= '</div>'; //wprig-productgrid
				}
				if ($layout === 2) {
					$html .= '<div class="wprig-productgrid wprig-post-grid-view wprig-productgrid-style-' . esc_attr($style) . '">';
			...
			if($enablePagination ){
				$html .= '<div class="wprig-productgrid-pagination">' . $this->wprig_product_pagination_bar($query->max_num_pages, $paged) . '</div>';
			}
			$html .= '</div>';
			wp_reset_postdata();
		}
