...
class WPRIG_SB_Product_Carousel{
				...
				'attributes' => array(
					...
					'badgePadding' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-post-grid-wrapper .wprig-sb-product-carousel-cat-position'
							]
						]
					),
					'showComment' => array(
					...
					'separatorColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-1:not(:last-child) {border-bottom-color: {{separatorColor}};}'
						]]
					),
					...
					'separatorHeight' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-1:not(:last-child){border-bottom-style: solid;border-bottom-width: {{separatorHeight}};}'
							],
						],
					),
					...
					'separatorSpace' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-1:not(:last-child){padding-bottom: {{separatorSpace}};margin-bottom: {{separatorSpace}};}'
							],
						],
					),
					...
					'cardBackground' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-sb-product-carousel-style-2'
							]
						]
					),
					'cardBorder' => array(
					...
					'cardSpace' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 2]],
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-2:not(:last-child) {margin-bottom: {{cardSpace}};}'
							]
						]
					),
					'cardPadding' => array(
					...
					'stackBg' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-3 .wprig-post-list-wrapper .wprig-post-list-content'
							],
							(object) [
								'condition' => [
									(object) ['key' => 'layout', 'relation' => '==', 'value' => 2],
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-sb-product-carousel-style-3 .wprig-post-grid-content'
							]
						]
					),
					...
					'stackWidth' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-sb-product-carousel-style-3 .wprig-post-grid-img + .wprig-post-grid-content {width: {{stackWidth}};}'
							]
						]
					),
					'stackSpace' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-3:not(:last-child) {margin-bottom: {{stackSpace}};}'
							]
						]
					...
					'stackPadding' => array(
						...
						'style' => [
							...
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-post-grid-view.wprig-sb-product-carousel-style-3 .wprig-post-grid-wrapper .wprig-post-grid-content'
							]
						]
					),
					...
					'titleTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-title'
						]]
					),
					'metaTypography' => array(
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-meta']]
					),
					'categoryTypography' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a'
						]]
					),
					...
					'cartButtonCustomSize' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-sb-product-carousel-btn-wrapper .wprig-sb-product-carousel-btn.wprig-button-fill.is-custom'
						]]
					),
					...
					'cartButtonTypography' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showTitle', 'relation' => '==', 'value' => true]],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-sb-product-carousel-btn'
						]]
					),
					'cartButtonColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel a.wprig-sb-product-carousel-btn {color: {{cartButtonColor}};}'
						]]
					...
					'cartButtonColor2' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel a.wprig-sb-product-carousel-btn {color: {{cartButtonColor2}};}'
						]]
					...
					'cartButtonHoverColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel a.wprig-sb-product-carousel-btn:hover {color: {{cartButtonHoverColor}};}'
						]]
					...
					'cartButtonHoverBg' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'cartButtonStyle', 'relation' => '==', 'value' => 'fill']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-sb-product-carousel-btn:hover'
						]]
					),
					...
					'contentPadding' => array(
						'type' => 'object',
						'default' => (object) array(),
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-post-grid-content,{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-post-list-content']]
					),
					'categoryRadius' => array(
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a']]
					),
					'titleColor' => array(
						'type'    => 'string',
						'default' => '#1b1b1b',
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-title a {color: {{titleColor}};}'
						]]
					),
					'titleOverlayColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-title a {color: {{titleOverlayColor}};}'
						]]
					),
					'titleHoverColor' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showTitle', 'relation' => '==', 'value' => true]],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-title a:hover {color: {{titleHoverColor}};}'
						]]
					),
					'categoryColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a {color: {{categoryColor}};}'
						]]
					),
					'categoryColor2' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a {color: {{categoryColor2}};}'
						]]
					),
					'categoryHoverColor' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'default']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a:hover {color: {{categoryHoverColor}};}'
						]]
					),
					'categoryBackground' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a {background: {{categoryBackground}};}'
						]]
					),
					'categoryHoverBackground' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a:hover {background: {{categoryHoverBackground}};}'
						]]
					),
					...
					'categoryHoverColor2' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'badge']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category a:hover {color: {{categoryHoverColor2}};}'
						]]
					),
					'metaColor' => array(
						'type'    => 'string',
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-meta a {color: {{metaColor}};} {{WPRIG}} .wprig-sb-product-carousel-meta {color: {{metaColor}};} {{WPRIG}} .wprig-sb-product-carousel-meta span:before {background: {{metaColor}};}'
						]]
					),
					'metaOverlayColor' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-meta a {color: {{metaOverlayColor}};} {{WPRIG}} .wprig-sb-product-carousel-meta {color: {{metaOverlayColor}};} {{WPRIG}} .wprig-sb-product-carousel-meta span:before {background: {{metaOverlayColor}};}'
						]]
					),
					...
					'color' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel .wprig-post-list-content {color: {{color}};}'
						]]
					),
					'bgColor' => array(
						'type' => 'object',
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 1]],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper'
						]]
					),
					'border' => array(
						'type' => 'object',
					...
					'overlayBg' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-style-4:before'
						]]
					),
					'overlayHoverBg' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-style-4:hover:before'
						]]
					),
					'overlayBorderRadius' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
								'selector' => '{{WPRIG}} .wprig-sb-product-carousel-style-4'
							]
						]
					),
					'overlaySpace' => array(
						...
						'style' => [
							(object) [
								'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
								'selector' => '{{WPRIG}} .wprig-post-list-view.wprig-sb-product-carousel-style-4:not(:last-child) {margin-bottom: {{overlaySpace}};}'
							]
						]
					),
					'overlayHeight' => array(
						...
						'style' => [
							(object) [
								...
								'selector' => '{{WPRIG}} .wprig-sb-product-carousel-style-4 {height: {{overlayHeight}};}'
							]
						]
					),
					'overlayBlend' => array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'style', 'relation' => '==', 'value' => 4]],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel.wprig-post-list-view.wprig-sb-product-carousel-style-4:before {mix-blend-mode: {{overlayBlend}};}'
						]]
					),
					//Spacing
					'columnGap' => array(
						...
						'style' => [(object) [
							...
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-column {grid-column-gap: {{columnGap}};}, {{WPRIG}} .wprig-sb-product-carousel-column {grid-row-gap: {{columnGap}};}'
						]]
					),
					'titleSpace' => array(
						'type' => 'object',
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-title {padding-bottom: {{titleSpace}};}']]
					),
					'categorySpace' => array(
						'type' => 'object',
						'default' => (object) array(
						...
						'style' => [(object) [
							'condition' => [(object) ['key' => 'showCategory', 'relation' => '==', 'value' => 'default']],
							'selector' => '{{WPRIG}} .wprig-sb-product-carousel-category {display:inline-block;padding-bottom: {{categorySpace}};}'
						]]
					),
					'metaSpace' => array(
						'type' => 'object',
						...
						'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-meta {padding-bottom: {{metaSpace}};}']]
					),
					'postSpace' => array(
						'type' => 'object',
						'default' => (object) array(
						...
						// 'style' => [(object) ['selector' => '{{WPRIG}} .wprig-sb-product-carousel-wrapper .wprig-sb-product-carousel']]
					),
					'interaction' => array(
						'type' => 'object',
						'default' => (object) array(),
	...
	function render_block_wprig_product_carousel($att){
		...
		if ($layout == 2) {
			...
			$col = "wprig-sb-product-carousel";
		}
		$class = 'wp-block-wprig-sb-product-carousel wprig-block-' . $uniqueId;
		if (isset($att['align'])) {
		...
		if ($query->have_posts()) {
			...
			$html .= '<div class="wprig-product wprig-sb-product-carousel-wrapper ' . $interaction . ' wprig-sb-product-carousel-layout-' . esc_attr($layout) . esc_attr($col) . '" ' . $animation . " data-slick='".json_encode($slickSettings)."'". ' >';
			...
			while ($query->have_posts()) {
				...
				$title = '<h3 class="wprig-sb-product-carousel-title"><a href="' . esc_url(get_the_permalink()) . '">' . get_the_title() . '</a></h3>';
				
				$category = '<span class="wprig-sb-product-carousel-category">' . get_the_category_list(' ') . '</span>';
				...
				$btn = '<div class="wprig-sb-product-carousel-btn-wrapper"><a class="button product_type_simple add_to_cart_button ajax_add_to_cart wprig-sb-product-carousel-btn wprig-button-' . esc_attr($cartButtonStyle) . ' is-' . esc_attr($cartButtonSize) . '" href="?add-to-cart=' . get_the_ID() . '" data-product-ID="'.get_the_ID().'" aria-label="Add '.get_the_title().'to your cart" rel="nofolow">' . esc_attr($cartButtonText) . '</a></div>';
				
				if ($layout === 1) {
					$html .= '<div class="wprig-sb-product-carousel wprig-post-list-view wprig-sb-product-carousel-style-' . esc_attr($style) . '">';
					...
					if (($showImages == 1) && has_post_thumbnail()) {
						if ($showCategory == 'badge'  && $style == 4) {
							$html .= '<div class="wprig-sb-product-carousel-cat-position wprig-sb-product-carousel-cat-position-' . esc_attr($categoryPosition) . '">';
							$html .= $category;
							$html .= '</div>';
						}
					...
					if (($showDates == 1) || ($showComment == 1)) {
						$html .= '<div class="wprig-sb-product-carousel-meta">';
						$html .= $meta;
						$html .= '</div>';
					}
				...
				if ($layout === 2) {
					$html .= '<div class="wprig-sb-product-carousel wprig-post-grid-view wprig-sb-product-carousel-style-' . esc_attr($style) . '">';
